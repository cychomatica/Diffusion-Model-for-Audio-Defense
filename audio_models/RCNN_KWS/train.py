...
from qualcomm_kws_dataset import QualcommKeywordSpottingDataset, LoadAudio, FixAudioLength, RandAudioLength
from model import CRNN, AttnMech, ApplyAttn, KWSModel
...
DATA_PATH = '/home/shutong/project/Diffusion_Model_for_Audio_Defense_Release/datasets/qualcomm_keyword_speech_dataset'
SAVE_PATH = '/home/shutong/project/Diffusion_Model_for_Audio_Defense_Release/audio_models/RCNN_KWS/checkpoints'

# QKWS_Data = QualcommKeywordSpottingDataset(folder=DATA_PATH, usage='All', transform=LoadAudio())
# QKWS_Loader = DataLoader(QKWS_Data, batch_size=1, shuffle=False, num_workers=0)
# total_duration_seconds = 0.
# assert len(QKWS_Data) == 4270
# for item in QKWS_Loader:
#     waveform = item['samples']

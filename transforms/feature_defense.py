...
class FeCo():
    ...
    def __init__(self, method='kmeans', param=0.5, other_param='L2') -> None:
    ...
    def __call__(self, feat, *args):
        ...
        return FEATURE_COMPRESSION(feat, self.method, self.param, self.other_param)

    def _get_name(self):

        name = 'FeCo-{}-{}-{}'.format(self.method, self.param, self.other_param)

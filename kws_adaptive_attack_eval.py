...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_path", default='datasets/qualcomm_keyword_speech_dataset')
    parser.add_argument("--classifier_type", type=str, choices=['advtr', 'vanilla'], default='advtr')
    ...
    parser.add_argument('--max_iter_1', type=int, default=50)
    ...
    classifier_path = 'audio_models/RCNN_KWS/checkpoints'
    if args.classifier_type == 'vanilla':
        classifier_path = os.path.join(classifier_path, 'vanilla-best-acc-kws-attn_rcnn-n_mels=32.pth')
    elif args.classifier_type == 'advtr': 
        classifier_path = os.path.join(classifier_path, 'advtr-best-robust-acc-kws-attn_rcnn-n_mels=32.pth')
    else:
    ...
    if args.defense == 'None':
        ...
        if args.defense == 'Diffusion':
            ...
            Defender = RevDiffWave(args).model
            defense_type = 'wave'
